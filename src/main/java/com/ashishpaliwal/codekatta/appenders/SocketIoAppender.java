 ...
 *
 */
public class SocketIoAppender extends AppenderSkeleton {
    ...
    public SocketIoAppender() {
    }

    /**
     Connects to remote server at <code>address</code> and <code>port</code>.
     */
    public SocketIoAppender(InetAddress address, int port) {
     ...
     */
    public SocketIoAppender(String host, int port) {
        this.port = port;
